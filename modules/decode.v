...
always @(posedge clk or negedge reset) begin
    if (!reset || flush) begin
        ...
        is_fpu_ext_out <= 0; fpu_op_out <= 0; valid_out <= 0;
        ...
        rd_addr_out <= rd; funct3_out <= funct3; funct7_bit5_out <= funct7_5;
        ...
        is_m_ext_out <= is_m_ext; is_fpu_ext_out <= is_fpu_ext;
        if (funct7 == 7'b0000000) fpu_op_out <= 4'd0;      // fadd.s
        else if (funct7 == 7'b0000100) fpu_op_out <= 4'd1; // fsub.s
        else if (funct7 == 7'b0001000) fpu_op_out <= 4'd5; // fmul.s
        else if (funct7 == 7'b0001100) fpu_op_out <= 4'd6; // fdiv.s
        else if (funct7 == 7'b0010100 && funct3 == 3'b000) fpu_op_out <= 4'd7; // fmin.s
        else if (funct7 == 7'b0010100 && funct3 == 3'b001) fpu_op_out <= 4'd8; // fmax.s
        else if (funct7 == 7'b1010000 && funct3 == 3'b010) fpu_op_out <= 4'd9; // feq.s
        else if (funct7 == 7'b1010000 && funct3 == 3'b001) fpu_op_out <= 4'd10; // flt.s
        else if (funct7 == 7'b1010000 && funct3 == 3'b000) fpu_op_out <= 4'd11; // fle.s
        else if (funct7 == 7'b1100000 && rs2 == 5'b00000) fpu_op_out <= 4'd12; // fcvt.w.s
        else if (funct7 == 7'b1100000 && rs2 == 5'b00001) fpu_op_out <= 4'd13; // fcvt.wu.s
        else if (funct7 == 7'b1101000 && rs2 == 5'b00000) fpu_op_out <= 4'd14; // fcvt.s.w
        else if (funct7 == 7'b1101000 && rs2 == 5'b00001) fpu_op_out <= 4'd15; // fcvt.s.wu
        else if (funct7 == 7'b1101000) fpu_op_out <= 4'd4; // round (legacy collision)
        else if (funct7 == 7'b1100000) fpu_op_out <= 4'd2; // floor (legacy collision)
        else if (funct7 == 7'b1100100) fpu_op_out <= 4'd3; // ceil
        else fpu_op_out <= 4'd0;
