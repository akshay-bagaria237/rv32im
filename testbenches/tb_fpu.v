...
module tb_fpu;
    ...
    initial begin
        ...
        $display("-------------------------------------------------------------------------");
        $display(" 7. Min/Max/Compare Operations");
        $display("-------------------------------------------------------------------------");
        run_test(4'd7, 32'h40000000, 32'h40400000, 32'h40000000, "min(2.0, 3.0) = 2.0      ");
        run_test(4'd7, 32'hC0000000, 32'hC0400000, 32'hC0400000, "min(-2.0, -3.0) = -3.0   ");
        run_test(4'd7, 32'h7F800000, 32'h40000000, 32'h40000000, "min(Inf, 2.0) = 2.0      ");
        run_test(4'd8, 32'h40000000, 32'h40400000, 32'h40400000, "max(2.0, 3.0) = 3.0      ");
        run_test(4'd8, 32'hC0000000, 32'hC0400000, 32'hC0000000, "max(-2.0, -3.0) = -2.0   ");
        run_test(4'd8, 32'h7F800000, 32'h40000000, 32'h7F800000, "max(Inf, 2.0) = Inf      ");
        run_test(4'd9, 32'h40000000, 32'h40000000, 32'd1, "2.0 == 2.0 -> 1          ");
        run_test(4'd9, 32'h40000000, 32'h40400000, 32'd0, "2.0 == 3.0 -> 0          ");
        run_test(4'd9, 32'h00000000, 32'h80000000, 32'd1, "0.0 == -0.0 -> 1         ");
        run_test(4'd10, 32'h40000000, 32'h40400000, 32'd1, "2.0 < 3.0 -> 1           ");
        run_test(4'd10, 32'h40400000, 32'h40000000, 32'd0, "3.0 < 2.0 -> 0           ");
        run_test(4'd10, 32'hC0400000, 32'hC0000000, 32'd1, "-3.0 < -2.0 -> 1         ");
        run_test(4'd11, 32'h40000000, 32'h40000000, 32'd1, "2.0 <= 2.0 -> 1          ");
        run_test(4'd11, 32'h40400000, 32'h40000000, 32'd0, "3.0 <= 2.0 -> 0          ");
        run_test(4'd11, 32'h00000000, 32'h80000000, 32'd1, "0.0 <= -0.0 -> 1         ");

        $display("-------------------------------------------------------------------------");
        $display(" 8. Converstions (Int <-> Float)");
        $display("-------------------------------------------------------------------------");
        run_test(4'd12, 32'h40A00000, 32'd0, 32'd5, "int(5.0) = 5             ");
        run_test(4'd12, 32'hC0A00000, 32'd0, 32'hFFFFFFFB, "int(-5.0) = -5           ");
        run_test(4'd12, 32'h00000000, 32'd0, 32'd0, "int(0.0) = 0             ");
        run_test(4'd13, 32'h40A00000, 32'd0, 32'd5, "uint(5.0) = 5            ");
        run_test(4'd13, 32'hC0A00000, 32'd0, 32'd0, "uint(-5.0) = 0           ");
        run_test(4'd14, 32'd5, 32'd0, 32'h40A00000, "float(5) = 5.0           ");
        run_test(4'd14, 32'hFFFFFFFB, 32'd0, 32'hC0A00000, "float(-5) = -5.0         ");
        run_test(4'd14, 32'd0, 32'd0, 32'h00000000, "float(0) = 0.0           ");
        run_test(4'd15, 32'd5, 32'd0, 32'h40A00000, "ufloat(5) = 5.0          ");
        run_test(4'd15, 32'hFFFFFFFF, 32'd0, 32'h4F800000, "ufloat(MAX) = ~4B        ");
